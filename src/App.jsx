                            ...
                            <>
                              ...
                              >
                                ...
                                <div className="absolute bottom-10 left-8 md:bottom-16 md:left-16 z-10 w-[80%] md:w-2/3">
                                  ...
                                  <h2 className="text-2xl md:text-4xl font-light italic leading-[1.1] text-[#EAE5D9] drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] transition-colors duration-500 mb-8">{heroArticle.title}</h2>
