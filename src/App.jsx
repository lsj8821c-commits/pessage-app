...
한국어로 출력. 영어는 섹션 라벨(OPENING/STRATEGY/RITUAL/CLOSING/PACING/NUTRITION/WALK ZONE)만 허용.`;
      ...
      >
        <div className="cursor-pointer" onClick={() => {setActiveTab('journal'); setSelectedArticle(null); setAuthMode(null); setIsProfileOpen(false);}}>
          <img src="/pessage_logo_TX_LT.svg" alt="PESSAGE" className="h-6 md:h-7 w-auto block dark:hidden" />
          <img src="/pessage_logo_TX_DK.svg" alt="PESSAGE" className="h-6 md:h-7 w-auto hidden dark:block" />
        </div>
                            ...
                            <>
                              ...
                              >
                                ...
                                <div className="absolute bottom-10 left-8 md:bottom-16 md:left-16 z-10 w-[80%] md:w-2/3">
                                  ...
                                  <h2 className="text-3xl md:text-5xl font-light italic leading-[1.1] text-[#EAE5D9] drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] transition-colors duration-500 mb-8">{heroArticle.title}</h2>
                      ...
                      <div className="space-y-3">
                        {selectedRoute.playlistUrl && (
                          <>
                            ...
                            <a
                              href={selectedRoute.playlistUrl.replace('www.youtube.com', 'music.youtube.com')}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="w-full py-4 rounded-sm font-bold uppercase text-[11px] tracking-[0.3em] transition-all flex items-center justify-center gap-3 border"
                              style={{borderColor:'var(--border-mid)', color:'var(--text-secondary)'}}
