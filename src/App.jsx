                        ...
                        {(() => {
                          ...
                          return (
                            <>
                              ...
                              >
                                <div className="w-full relative max-h-[60vh] md:max-h-[85vh] overflow-hidden" style={{background:'var(--bg-surface)'}}>
                                  {heroArticle.coverImage && (
                                    <img
                                      src={urlFor(heroArticle.coverImage)}
                                      className="w-full h-full object-cover block max-h-[60vh] md:max-h-[85vh]"
